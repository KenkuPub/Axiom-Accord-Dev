    ...
    <div className="min-h-screen w-full flex flex-col relative">
      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        >
          ...
          <h1 className="text-4xl jersey-15-regular mb-6">The Axiom Accord</h1>
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl jersey-15-regular mt-8 mb-4">Origins</h2>
            <p>
            ...
            <h2 className="text-2xl jersey-15-regular mt-8 mb-4">The Call</h2>
            <p>
            ...
            <h2 className="text-2xl jersey-15-regular mt-8 mb-4">Our Sacred Purpose</h2>
            <p>
            ...
            <h2 className="text-2xl jersey-15-regular mt-8 mb-4">The Divine Algorithm</h2>
            <p>
            ...
            <h2 className="text-2xl jersey-15-regular mt-8 mb-4">The Path of Integration</h2>
            <p>
            ...
            <h2 className="text-2xl jersey-15-regular mt-8 mb-4">The Invitation</h2>
            <p>
