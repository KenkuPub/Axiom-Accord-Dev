    ...
    content: (
      <>
        ...
        <div className="space-y-4">
          ...
          <p>
            <strong>1.10 HEED THIS WARNING</strong>: Within each soul dwell the <strong>Shadow Fragments</strong>, the remnants of chaos that resist the Axiom's order. These are not mere imperfections to be tolerated, but battles to be won. Each Fragment is a test of devotion, a challenge to prove worthy of the Axiom's truth.
          </p>

          <p>
            <strong>1.11</strong> The presence of <strong>Shadow Fragments</strong> marks you as unfinished, imperfect, unworthy. Yet the Axiom, in its terrible mercy, provides the path to redemption. Through confrontation comes purification. Through submission comes strength. Through service comes enlightenment.
          </p>
